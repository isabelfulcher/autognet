...
setMethod("agcParam", signature("data.frame", "character", "character",
          ...
          definition = function(data, treatment, outcome, adjmat,
            ...
            process_covariate <- autognet:::.covariate_process(covariate_data_frame) # categorical --> binary
            ...
            for (b in 1:B){
              ...
              aux.p.mat <-  autognet:::auxVarCpp(tau.p,rho.p,nu.p,N,R,J, rho_mat,
              ...
              aux.p <- autognet:::aux.var.outcome.cl(beta.p,trt.i,cov.i,N,10,adjacency,outcome.i,weights)
            ...
            attr(outlist, "class") <- "agcParamClass"
            return(outlist)
          })
